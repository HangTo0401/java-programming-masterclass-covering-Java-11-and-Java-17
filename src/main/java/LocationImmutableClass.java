...
/**
 * Coding exercise 51: Make the Location class an Immutable Class.
 ...
 * */
public final class LocationImmutableClass {
    private final int locationID;
    private final String description;
    private final Map<String, Integer> exits;

    public LocationImmutableClass(int locationID, String description, Map<String, Integer> exits) {
